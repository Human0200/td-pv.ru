...
BX.addCustomEvent('onSubmitForm', function (eventdata) {
	try {
      ...
      const validateInputName  = `aspro_${arAsproOptions.SOLUTION_NAME}_form_validate`;
      if (!eventdata.form.querySelector(`[name="${validateInputName}"]`)) {
        eventdata.form.appendChild(
          BX.create('input', {
            attrs: {
              type: 'hidden',

												...
												<?if ($bShowBtn):?>
													<div class="accordion-btn">
														<?if ($arItem['DISPLAY_PROPERTIES']['FORM_CODE']['VALUE']):?>
															<span class="btn btn-default btn-transparent-border animate-load" data-event="jqm" data-param-id="<?=TSolution::getFormID($arItem['DISPLAY_PROPERTIES']['FORM_CODE']['VALUE'])?>" data-name="question" data-autoload-need_product="<?=TSolution::formatJsName($arItem['NAME'])?>"><?=$arItem['DISPLAY_PROPERTIES']['TITLE_BUTTON']['VALUE'];?></span>
														<?else:?>

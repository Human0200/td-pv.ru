                                ...
                                <div class="flexbox flexbox--direction-<?=$bCenteredBlock ? 'column' : 'row';?>">
                                    ...
                                    <div class="form-send__info<?=$bCenteredBlock ? '' : ' form-send--mt-n7';?>">
                                        ...
                                        <?if ($arParams['DISPLAY_CLOSE_BUTTON'] != 'N'):?>
                                            <div class="btn btn-transparent-border btn-lg reload-page"><?=$arParams['CLOSE_BUTTON_NAME'] ?: Loc::getMessage('SEND_MORE');?></div>
                        ...
                        <div class="form-inner flex-1">
                            ...
                            <div class="form-footer">
                                ...
                                <div class="form-footer__btn">
                                    <button type="submit" class="<?=$arParams['SEND_BUTTON_CLASS'];?>">
                                        <span>
                                            <?=$arParams['SEND_BUTTON_NAME'] ?: $arResult['arForm']['BUTTON'];?>
                                        </span>
                                    </button>
                                </div>
                                <input type="hidden" class="<?=$arParams['SEND_BUTTON_CLASS'];?>" value="<?=$arParams['SEND_BUTTON_NAME'] ?: $arResult['arForm']['BUTTON'];?>" name="web_form_submit">
                            </div>

...
<div class="catalog-detail__top-info bordered rounded-4 flexbox flexbox--direction-row flexbox--wrap-nowrap">
	...
	<meta itemprop="brand" content="ООО «Промышленная вентиляция»" />
	...
	<div class="catalog-detail__main">
		<? if (
			...
			<div class="catalog-detail__info-tc">
				...
				<?= TSolution\Functions::showSchemaAvailabilityMeta($statusCode ?: 'instock'); ?>
										...
										<? if (strlen($status)): ?>
											<div class="line-block__item font_13">
												...
												<span
													...
													data-value="<?= $arResult['DISPLAY_PROPERTIES']['STATUS']['VALUE'] ?>"><?= $status ?></span>
											</div>
										<? endif; ?>
										...
										<? if (strlen($article)): ?>
											<div class="line-block__item font_13 color_999">
												<span class="article"><?= GetMessage('S_ARTICLE') ?>&nbsp;<span
														...
														data-value="<?= $arResult['DISPLAY_PROPERTIES']['ARTICLE']['VALUE'] ?>"><?= $article ?></span></span>
											</div>
										<? endif; ?>
									</div>
								</div>

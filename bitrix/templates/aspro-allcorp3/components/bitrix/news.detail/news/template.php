...
$arCrossLinkedProps = array('LINK_SERVICES', '', 'LINK_ARTICLES', 'LINK_NEWS', 'LINK_PROJECTS', 'LINK_SALE', 'LINK_TARIF', 'LINK_STAFF', 'LINK_PARTNERS');
...
$templateData = array(
	...
	'TIZERS' => TSolution\Functions::getCrossLinkedItems($arResult, array('LINK_TIZERS'), [], $arParams),
	...
	'PARTNERS' => TSolution\Functions::getCrossLinkedItems($arResult, array('LINK_PARTNERS'), $arCrossLinkedProps, $arParams),
	'SALE' => TSolution\Functions::getCrossLinkedItems($arResult, array('LINK_SALE'), $arCrossLinkedProps, $arParams),
	'NEWS' => TSolution\Functions::getCrossLinkedItems($arResult, array('LINK_NEWS'), $arCrossLinkedProps, $arParams),
	'STAFF' => TSolution\Functions::getCrossLinkedItems($arResult, array('LINK_STAFF'), $arCrossLinkedProps, $arParams),
	'ARTICLES' => TSolution\Functions::getCrossLinkedItems($arResult, array('LINK_ARTICLES'), $arCrossLinkedProps, $arParams),
	'PROJECTS' => TSolution\Functions::getCrossLinkedItems($arResult, array('LINK_PROJECTS'), $arCrossLinkedProps, $arParams),
	'SERVICES' => TSolution\Functions::getCrossLinkedItems($arResult, array('LINK_SERVICES'), $arCrossLinkedProps, $arParams),
	'GOODS' => TSolution\Functions::getCrossLinkedItems($arResult, array('LINK_GOODS', 'LINK_GOODS_FILTER'), $arCrossLinkedProps, $arParams),
	'TARIFFS' => TSolution\Functions::getCrossLinkedItems($arResult, array('LINK_TARIF'), $arCrossLinkedProps, $arParams),
	...
	<?if (!$templateData['IMG_TOP_SIDE']):?>
		...
		<?TSolution\Functions::showBlockHtml([
			...
			'PARAMS' => [
				...
				'URL' => $arResult['DETAIL_PICTURE']['SRC'].'?v=1.2.10',
				'ALT' => $atrAlt,
				'TITLE' => $atrTitle,
				'TOP_IMG' => $bTopImg
			],

        ...
        <div class="form border_block">
            <div class="wrap_md">
                <div class="main_info iblock max-form-block">
                        ...
                        $(document).ready(function() {
                            ...
                            $("form#registraion-page-form").validate({
                                ...
                                submitHandler: function(form) {
                                    const eventdata = {type: 'form_submit', form: form, form_name: 'REGISTER'};
                    ...
                    <form id="registraion-page-form" class="flexbox" method="post" action="<?=POST_FORM_ACTION_URI;?>" name="regform" enctype="multipart/form-data">
                        <?if ($arResult['BACKURL'] != ''):?>
                        ...
                        <?if (TSolution::GetFrontParametrValue("SHOW_LICENCE") === "Y"):?>
                            <div class="userconsent-wrap mt mt--20">

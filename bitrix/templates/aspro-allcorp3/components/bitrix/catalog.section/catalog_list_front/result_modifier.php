...
use Bitrix\Main\Loader; // <--- УБЕДИТЕСЬ, ЧТО ЭТО ЕСТЬ
...
// <--- УБЕДИТЕСЬ, ЧТО ЭТО ЕСТЬ: Проверка и подключение модуля инфоблоков
...
// <--- ДОБАВЛЕНО/ПРОВЕРЕНО: Кэш для кодов корневых разделов
...
if (!empty($arResult['ITEMS'])) {
	...
	foreach ($arResult['ITEMS'] as $key => $arItem) {
		...
		// $arItem['LAST_ELEMENT'] = 'N'; // Переместим

		...
		<ul class="bx-catalog-tab-list1 nav nav-tabs" style="left: 0;"><?
			foreach ($arData as $tabId => $arTab)
			{
				if (isset($arTab["NAME"]) && isset($arTab["CONTENT"]))
				{
					...
					?>
					<li id="<?=$id?>" class="color_666 bordered rounded-4 font_14 <?=$tabId;?>"><a href="#<?=$id;?>_cont" data-toggle="tab"><?=($iconSVG ? CAllcorp3::showIconSvg(strtolower($tabId), $iconSVG) : '');?><?=$arTab["NAME"]?></a></li>
					<?

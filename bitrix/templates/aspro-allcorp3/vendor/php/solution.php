...
namespace {
    ...
    foreach ([
        ...
        'Aspro\Allcorp3\Basket' => 'TSolution\Basket',
        ...
        'Aspro\Allcorp3\Captcha' => 'TSolution\Captcha',
        'Aspro\Allcorp3\Captcha\Service' => 'TSolution\Captcha\Service',
        ...
        'Aspro\Allcorp3\Product\Offers\Compare' => 'TSolution\Product\Offers\Compare',
        ...
        'Aspro\Allcorp3\Social\Factory' => 'TSolution\Social\Factory',
        'Aspro\Allcorp3\Social\Video\Factory' => 'TSolution\Social\Video\Factory',
        'Aspro\Allcorp3\Utils' => 'TSolution\Utils',
        'Aspro\Allcorp3\Video\Iframe' => 'TSolution\Video\Iframe',
        'Aspro\Allcorp3\CacheableUrl' => 'TSolution\CacheableUrl',
        'Aspro\Functions\CAsproAllcorp3Custom' => 'TSolution\FunctionsCustom',
        'Aspro\Allcorp3\Grupper' => 'TSolution\Grupper',
        'Aspro\Allcorp3\Template\Epilog\Blocks' => 'TSolution\Template\Epilog\Blocks',
    ] as $original => $alias) {
...
namespace TSolution {
    if (false) {
        class Basket extends \Aspro\Allcorp3\Basket
        {
        }
        ...
        class Grupper extends \Aspro\Allcorp3\Grupper
        {
        }
        ...
        class CacheableUrl extends \Aspro\Allcorp3\CacheableUrl
        {
        }

        class Captcha extends \Aspro\Allcorp3\Captcha
        {
        }
    }
}
...
namespace TSolution\Product\Offers {
    if (false) {
        class Compare extends \Aspro\Allcorp3\Product\Offers\Compare
        {
        }
    }
}
...
namespace TSolution\Social {
    if (false) {
        class Factory extends \Aspro\Allcorp3\Social\Factory
        {
        }
    }
}
...
namespace TSolution\Social\Video {
    if (false) {
        class Factory extends \Aspro\Allcorp3\Social\Video\Factory
        {
        }
    }
}
...
namespace TSolution\Captcha {
    if (false) {
        class Service extends \Aspro\Allcorp3\Captcha\Service
        {
        }
    }
}
...
namespace TSolution\Template\Epilog {
    if (false) {
        class Blocks extends \Aspro\Allcorp3\Template\Epilog\Blocks
        {
        }
    }
}

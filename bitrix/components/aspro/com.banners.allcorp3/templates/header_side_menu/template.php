...
if (empty($arResult['ITEMS']['HEADER_WIDE_MENU']['ITEMS'])) {
    return;
}
...
?>
<div class="bottom-banners line-block line-block--gap line-block--gap-20 line-block--align-normal">
    <div class="slider-solution--init-by-condition swiper mobile-offset" data-plugin-options='<?=\Bitrix\Main\Web\Json::encode($arOptions);?>'>
        <div class="swiper-wrapper">
            <?foreach ($arResult['ITEMS']['HEADER_WIDE_MENU']['ITEMS'] as $arItem):?>
                ...
                $slideClassList = ['bottom-banners__item swiper-slide swiper-slide--height-auto'];
                if ($link) {
                ...
                <?ob_start();?>
                    <?if ($picture):?>
                        <img class="bottom-banners__item-img rounded-4" src="<?=$picture;?>">
                    <?endif; ?>
                    ...
                    <div class="bottom-banners__item-text">
                        ...
                        <?if ($date):?>
                            <time datetime="<?=$arItem['ACTIVE_FROM_X'];?>" class="bottom-banners__item-date font_13">
                                <?=$date;?>
                            </time>
                        <?endif; ?>
                    </div>
                ...
                <?if ($link):?>
                    ...
                    ?>
                    <a class="<?=$slideClass;?>" href="<?=$link;?>"<?=$attributes;?>>
                        <?=$slideContent;?>
                    </a>
                <?else:?>
    ...
    <?if ($arOptions['countSlides'] > 1):?>
        <div class="navigation-pagination">
            <div class="line-block line-block--column line-block--justify-between line-block--gap line-block--gap-12 height-100">
                <?TSolution\Functions::showBlockHtml([
                    'FILE' => 'ui/slider-pagination.php',
                    'PARAMS' => [
                        'CLASSES' => 'swiper-pagination--small static line-block--justify-center line-block--flex-wrap',
                    ],
                ]);?>

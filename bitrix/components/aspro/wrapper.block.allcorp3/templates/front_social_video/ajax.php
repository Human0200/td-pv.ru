...
if ($arParams['SHOW_TITLE'] === 'FROM_THEME') {
	$arParams['SHOW_TITLE'] = TSolution::getFrontParametrValue('SHOW_TITLE_'.$codeBlock.$codeBlockSuffix.'_'.$indexType);
}
...
if ($arParams['WIDE'] === 'Y' && $arParams['ITEMS_OFFSET'] === 'N') {
	$arParams['MAXWIDTH_WRAP'] = 'N';
}
?>

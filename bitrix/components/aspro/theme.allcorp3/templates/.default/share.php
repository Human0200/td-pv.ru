...
try {
	...
	if(
		...
		(
			strpos($_SERVER['SERVER_NAME'], 'allcorp3-demo.ru') !== false ||
	...
	<div class="form">
			...
			<div class="content-body">
				<div class="style-switcher-line-block style-switcher-flexbox--justify-beetwen">
					<div class="style-switcher-line-block__item">
						<div class="sharepreset-title"><?=TSolution::showIconSvg('share-export', dirname($_SERVER['SCRIPT_NAME']).'/images/svg/share-export.svg');?><?=Loc::getMessage('TA_T_EXPORT_TITLE')?></div>
					</div>
					<div class="style-switcher-line-block__item">
						<a href="" rel="nofollow" class="sharepreset-blocks-toggle dark_link">
							...
							)?></span><?=TSolution::showIconSvg('share-arrow-down', dirname($_SERVER['SCRIPT_NAME']).'/images/svg/share-arrow-down.svg');?>
						</a>
					</div>
				</div>
				...
				<form action="<?=$_SERVER['REQUEST_URI']?>" method="post">
					...
					<input type="hidden" name="moduleId" value="<?=TSolution::moduleID?>" />
		...
		<div class="sharepreset-part sharepreset-part--import">
			<div class="content-body">
				<div class="sharepreset-title"><?=TSolution::showIconSvg('share-import', dirname($_SERVER['SCRIPT_NAME']).'/images/svg/share-import.svg');?><?=Loc::getMessage('TA_T_IMPORT_TITLE')?></div>
							...
							submitHandler: function (form){
								if($form.valid()){
									if(!$form.closest('.form').hasClass('sending')){
										...
										var componentName = '<?=TSolution::partnerName?>:theme.<?=TSolution::themesSolutionName?>';
